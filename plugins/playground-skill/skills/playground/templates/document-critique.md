...
Next to the "Copy Prompt" button, include a "Send to Claude" button and the transport snippet from SKILL.md. The prompt output area should have `id="prompt-output"` and the send button should have `id="send-btn"`.
